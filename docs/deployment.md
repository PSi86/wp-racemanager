...
1.12.2 shows the heats no class claims - RotorHazard's "Unclassified", class null since RotorHazard
4.4.0 and 0 before, or a class the timer no longer has - in a section of their own at the foot of
the bracket view, `#class-0-display`
